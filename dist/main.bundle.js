...
var JsonDataService = (function () {
    ...
    JsonDataService.prototype.getEmail = function (email) {
        return this.http.get('http://localhost:4000/checkEmail?email=' + email).map(function (response) { return [response['_body'], console.log(response['_body'])]; });
    };
    ;
...
var ForgotPasswordComponent = (function () {
    ...
    ForgotPasswordComponent.prototype.onResetLink = function () {
        ...
        this.JsonDataService.getEmail(this.userForm.value.email).subscribe(function (resEmailData) { return [
            _this.candidates = resEmailData, _this.verifyUserReset(), console.log("can : " + _this.candidates)
        ]; }, function (error) {
